...
// interface ThreeShaderMaterial extends THREE.ShaderMaterial {
//   uniforms: Record<string, { value: UniformValue; type?: string }>;
// }
...
//   // Memoize the prepared uniforms first, without depending on the material
//   const preparedUniforms = useMemo(() => {
//     const result: Record<string, { value: UniformValue; type?: string }> = {};
...
//   // Create the material separately
...
//     }) as ThreeShaderMaterial;
//   }, [source, preparedUniforms]);

//   // Update the material uniforms and time
//   useFrame((state) => {
